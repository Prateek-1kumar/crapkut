    ...
    return (
      <header className="w-full py-10 sm:py-16 px-6 sm:px-12 flex flex-col items-center transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]">
        <div className="max-w-4xl w-full mx-auto flex flex-col items-center text-center animate-fade-in">
          {/* Subtle Studio Pill */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white/70 dark:bg-white/[0.05] border border-black/10 dark:border-white/10 backdrop-blur-md shadow-2xs mb-5 text-[11px] font-medium text-text-secondary transition-colors duration-500">
          ...
          <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-normal tracking-tight text-text-primary leading-[1.1] mb-4 transition-colors duration-500">
            Real-Time Specification Parity & Market Valuation Engine
          </h1>

          <p className="text-xs sm:text-sm text-text-secondary max-w-xl text-center font-normal leading-relaxed mb-8 transition-colors duration-500">
          ...
          <form
            ...
            className="w-full max-w-2xl relative flex items-center backdrop-blur-2xl bg-white/90 dark:bg-white/[0.06] border border-black/15 dark:border-white/15 hover:border-black/30 dark:hover:border-white/25 focus-within:border-black/50 focus-within:dark:border-white/40 focus-within:bg-white focus-within:dark:bg-white/[0.1] rounded-full shadow-[0_12px_40px_rgb(0,0,0,0.06)] dark:shadow-[0_12px_40px_rgb(0,0,0,0.4)] transition-all duration-500 p-1.5 sm:p-2 group"
          >
            ...
            <button
              ...
              className="px-5 sm:px-6 py-2 sm:py-2.5 bg-[#1A1918] dark:bg-[#F9F8F6] hover:bg-black dark:hover:bg-white disabled:bg-black/10 disabled:dark:bg-white/10 disabled:text-black/30 disabled:dark:text-white/30 text-[#F9F8F6] dark:text-[#1A1918] font-medium rounded-full text-xs sm:text-sm transition-all duration-300 ease-out flex items-center gap-1.5 cursor-pointer disabled:cursor-not-allowed shrink-0 shadow-2xs hover:scale-[1.01] active:scale-95"
            >
              {isLoading ? (
          ...
          {isLoading && (
            <div className="mt-6 flex items-center justify-center gap-2 text-xs text-text-secondary animate-pulse font-medium bg-white/80 dark:bg-white/[0.08] backdrop-blur-md px-4 py-1.5 rounded-full border border-black/10 dark:border-white/15 shadow-xs">
          ...
          ========================================== */}
          <div className="mt-12 sm:mt-16 w-full pt-6 border-t border-black/[0.06] dark:border-white/[0.08] flex flex-col items-center">
          ...
          <div className="mt-12 sm:mt-14 w-full grid grid-cols-1 md:grid-cols-3 gap-5 text-left">
            <div className="backdrop-blur-2xl bg-white/60 dark:bg-white/[0.04] border border-black/[0.06] dark:border-white/10 rounded-2xl p-5 sm:p-6 shadow-[0_8px_25px_rgb(0,0,0,0.03)] dark:shadow-[0_12px_35px_rgb(0,0,0,0.3)] hover:bg-white/80 dark:hover:bg-white/[0.08] transition-all duration-500 flex flex-col gap-2.5">
              <div className="w-9 h-9 rounded-xl bg-[#1A1918] dark:bg-[#F9F8F6] text-[#F9F8F6] dark:text-[#1A1918] flex items-center justify-center shadow-xs transition-colors duration-500">
                <FiLayers size={16} />
              </div>
